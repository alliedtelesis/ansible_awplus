...
tests = {
    ...
    "co_1": ['no openflow controller bob', 'no openflow controller fred', 'no openflow controller dave', 'openflow controller andy tcp 192.168.2.100 6654',
             'interface port1.6.1', 'no openflow', 'interface port1.6.2', 'no openflow', 'interface port1.6.3', 'no openflow', 'interface port1.6.4',
             'no openflow', 'no openflow inactivity', 'no openflow native vlan', 'no openflow datapath-id', 'no openflow failmode'],
    "co_2": ['no openflow controller bob', 'no openflow controller dave', 'no openflow controller fred', 'openflow controller bob tcp 192.168.1.100 6653',
             'interface port1.6.1', 'no openflow', 'interface port1.6.2', 'no openflow', 'interface port1.6.3', 'no openflow', 'interface port1.6.4',
             'no openflow', 'no openflow inactivity', 'no openflow native vlan', 'no openflow datapath-id', 'no openflow failmode'],
    "co_3": ['no openflow controller dave', 'no openflow controller fred', 'no openflow controller bob', 'openflow controller bob tcp 192.168.2.100 6654',
             'interface port1.6.1', 'no openflow', 'interface port1.6.2', 'no openflow', 'interface port1.6.3', 'no openflow', 'interface port1.6.4',
             'no openflow', 'no openflow inactivity', 'no openflow native vlan', 'no openflow datapath-id', 'no openflow failmode'],
    "co_4": [],
