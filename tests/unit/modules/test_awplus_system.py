...
from ansible_collections.alliedtelesis.awplus.plugins.modules import awplus_system
...
class TestAwplusSystemModule(TestAwplusModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch(
            "ansible_collections.alliedtelesis.awplus.plugins.modules.awplus_system.get_config"
        )
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch(
            "ansible_collections.alliedtelesis.awplus.plugins.modules.awplus_system.load_config"
        )
    ...
    def test_awplus_system_domain_list_complex(self):
        ...
        commands = ["no ip domain-list example.net", "ip domain-list ansible.com"]
        self.execute_module(changed=True, commands=commands, sort=False)
