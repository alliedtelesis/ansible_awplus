...
class TestAwplusFactsModule(TestAwplusModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            "ansible_collections.alliedtelesis.awplus.plugins.module_utils.facts.legacy.base.run_commands"
        )
        ...
        self.mock_get_capabilities = patch(
            "ansible_collections.alliedtelesis.awplus.plugins.module_utils.facts.legacy.base.get_capabilities"
        )
