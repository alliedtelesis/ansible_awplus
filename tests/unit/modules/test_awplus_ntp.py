...
class TestAwplusNtpModule(TestAwplusModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch(
            "ansible_collections.alliedtelesis.awplus.plugins.modules.awplus_ntp.get_config"
        )
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch(
            "ansible_collections.alliedtelesis.awplus.plugins.modules.awplus_ntp.load_config"
        )
    ...
    def load_fixtures(self, commands=None):
        self.get_config.return_value = load_fixture("awplus_ntp_config.cfg").strip()
