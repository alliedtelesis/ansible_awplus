...
from ansible_collections.alliedtelesis.awplus.plugins.module_utils.argspec.lag_interfaces.lag_interfaces import (
    Lag_interfacesArgs,
)
from ansible_collections.alliedtelesis.awplus.plugins.module_utils.config.lag_interfaces.lag_interfaces import (
    Lag_interfaces,
)
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=Lag_interfacesArgs.argument_spec, supports_check_mode=True
    )
